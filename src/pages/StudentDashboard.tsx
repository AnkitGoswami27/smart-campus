...
const StudentDashboard: React.FC = () => {
  ...
  const [announcements] = useLocalStorage('admin-announcements', []);
  ...
  // Update announcements when admin creates new ones
  useEffect(() => {
    if (announcements.length > 0) {
      ...
      setRecentAnnouncements(prev => [...formattedAnnouncements, ...prev.slice(0, 2)]);
    }
  }, [announcements]);
